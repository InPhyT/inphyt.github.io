...
1. **Interaction network scraping**: user timeline-aggregated interaction network has been extracted $\forall y \in Y$ in order to filter the subset $X \subset Y$ of those who are still active and sufficiently connected ( $\sim 10,000$ ).

2. **Users activity monitoring**: A detailed temporal activity monitoring pipeline has been launched $\forall x \in X$.
